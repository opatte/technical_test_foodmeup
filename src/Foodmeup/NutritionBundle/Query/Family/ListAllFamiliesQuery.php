...
/**
 * Class ListAllFamiliesQuery.
 */
class ListAllFamiliesQuery extends BaseQueryListAll
{
    /**
     * @var string
     */
     ...
     * @var array
     */
    protected $filtersAllowed = ['status', 'search', 'content_lang', 'content_slug', 'content_name',
                                'content_status', 'uuids', ];
     ...
     * @var array
     */
    protected $fieldsAllowed = ['uuid', 'origgpcd'];
     ...
     * @var array
     */
    protected $sortsAllowed = ['status', 'createdAt', 'updatedAt', 'origgpcd'];
